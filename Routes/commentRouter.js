...
router.get('/comment-product', checkSignIn(),checkRole(10075),commentCtr.getListCommentForProduct);
router.get('/comment-details', checkSignIn(),checkRole(10072),commentCtr.get_Comment_Detail);
